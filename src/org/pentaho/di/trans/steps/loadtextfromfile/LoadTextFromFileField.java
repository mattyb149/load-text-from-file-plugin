 ...
 *
 */
public class LoadTextFromFileField implements Cloneable
{
    ...
    public final static String trimTypeDesc[] = {
      BaseMessages.getString(PKG, "LoadTextFromFileField.TrimType.None"),
      BaseMessages.getString(PKG, "LoadTextFromFileField.TrimType.Left"),
      BaseMessages.getString(PKG, "LoadTextFromFileField.TrimType.Right"),
      BaseMessages.getString(PKG, "LoadTextFromFileField.TrimType.Both")
    };
    ...
    public final static String ElementTypeDesc[] = {
        BaseMessages.getString(PKG, "LoadTextFromFileField.ElementType.FileContent"),
        BaseMessages.getString(PKG, "LoadTextFromFileField.ElementType.FileSize"),
      };
	...
	public LoadTextFromFileField(String fieldname)
	{
		this.name           = fieldname;
	...
	public LoadTextFromFileField(Node fnode) throws KettleValueException
    {
    ...
    public Object clone()
	{
		try
		{
			LoadTextFromFileField retval = (LoadTextFromFileField) super.clone();
